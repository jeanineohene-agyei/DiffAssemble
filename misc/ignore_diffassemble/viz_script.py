...
from misc.ignore_diffassemble.puzzle_diff.model import spatial_diffusion_discrete as sdd
from misc.ignore_diffassemble.puzzle_diff.model import spatial_diffusion_discrete_rot as sdd_rot
